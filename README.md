...
**Note**: This app was originally designed as a QR code-based storage tracker but was simplified to use a number-based system for better usability and accessibility.